<template>
  ...
  <div  class="cube_container" @mouseenter="startTurning" @mouseleave="stopTurning">
    <div class="cube" :style="{ transform: `rotateY(${cube}deg)` }">
      <div class="face front">
        <img class="header_logo" src="~/assets/content/images/gravitylabs_logo_2.webp" alt="GravLabs Logo">
      </div>
      <div class="face back"> <img class="header_logo" src="~/assets/content/images/gravitylabs_logo_2.webp" alt="GravLabs Logo"></div>
      <div class="face top"></div>
      <div class="face bottom"></div>
      <div class="face left"> <img class="header_logo" src="~/assets/content/images/gravitylabs_logo_2.webp" alt="GravLabs Logo"></div>
      <div class="face right"> <img class="header_logo" src="~/assets/content/images/gravitylabs_logo_2.webp" alt="GravLabs Logo"></div>
  </div>
</div>
            </div>
