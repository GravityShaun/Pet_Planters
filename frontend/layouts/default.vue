<template>
  ...
  <div>
    <EfxCursorFxCustomCursor />
    <div class="cursor_class">
      <slot></slot>
    </div>
      ...
      <div class="modal_container" :class="{ modal_hide_anim: modalExitAnim, modal_hide_disp: modalExitDisplay }">
        <div class="modal_popup" :class="{ modal_bix_hide_anim: modalExitAnim }" ref="modal">
          <div class="input_wrap input_wrap_edit_1">
            <input v-model="sitePassword" type="text" class="input_white input_edit_1" placeholder=' Enter a password. '
              required />
...
import { Themes, applyTheme } from '~/assets/css/themes.js'
...
const cursor_style = useCookie('cursor_style', { default: () => 'none', watch: true })
